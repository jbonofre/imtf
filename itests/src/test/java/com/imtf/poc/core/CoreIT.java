...
public class CoreIT extends KarafTestSupport {
    ...
    public void mainTest() throws Exception {
        ...
        addFeaturesRepository("mvn:com.imtf.poc/imtf-poc-core-features/1.0-SNAPSHOT/xml");

        installAndAssertFeature("imtf-poc-core");

        assertServiceAvailable(DocumentService.class);

        DocumentService documentService = getOsgiService(DocumentService.class);

        documentService.add(1L, "ITest");
        Assert.assertEquals(1, documentService.documents().size());
        Assert.assertEquals("ITest", documentService.get(1L));
    }
